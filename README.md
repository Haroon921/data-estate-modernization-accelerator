...
[![CI](https://github.com/Haroon921/data-estate-modernization-accelerator/actions/workflows/ci.yml/badge.svg)](https://github.com/Haroon921/data-estate-modernization-accelerator/actions/workflows/ci.yml)
[![Release](https://img.shields.io/github/v/release/Haroon921/data-estate-modernization-accelerator?color=00B4A6)](https://github.com/Haroon921/data-estate-modernization-accelerator/releases/latest)
...
The [editable calculator overview](enablement/business-case-calculator-overview.pptx) explains the SQL and Fabric economic models, their connected inputs, and the illustrative outputs generated by the included workbook.

![Animated business-case calculator walkthrough](docs/assets/calculator/calculator-walkthrough.gif)
...
Open `business-case/modernization_business_case.xlsx`, replace the yellow placeholder inputs with validated customer data, and review the Summary and Sensitivity worksheets.
...
|-- docs/             # Architecture visuals and calculator walkthrough
